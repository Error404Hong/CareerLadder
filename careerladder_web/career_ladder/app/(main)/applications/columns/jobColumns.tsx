...
const statusConfig: Record<string, { label: string; className: string; icon: React.ReactNode }> = {
    pending: { label: "Pending", className: "bg-yellow-100 text-yellow-600 border border-yellow-100", icon: <Clock size={11} /> },
    reviewed: { label: "Reviewed", className: "bg-blue-100 text-blue-600 border border-blue-100", icon: <AlertCircle size={11} /> },
    shortlisted: { label: "Shortlisted", className: "bg-purple-100 text-purple-600 border border-purple-100", icon: <AlertCircle size={11} /> },
    accepted: { label: "Accepted", className: "bg-green-100 text-green-600 border border-green-100", icon: <CheckCircle2 size={11} /> },
    rejected: { label: "Rejected", className: "bg-red-100 text-red-500 border border-red-100", icon: <XCircle size={11} /> },
}
