...
const statusConfig: Record<string, { label: string; className: string; icon: React.ReactNode }> = {
    pending: { label: "Pending", className: "bg-yellow-50 text-yellow-600 border border-yellow-100", icon: <Clock size={13} /> },
    reviewed: { label: "Reviewed", className: "bg-blue-50 text-blue-600 border border-blue-100", icon: <AlertCircle size={13} /> },
    shortlisted: { label: "Shortlisted", className: "bg-purple-50 text-purple-600 border border-purple-100", icon: <AlertCircle size={13} /> },
    accepted: { label: "Accepted", className: "bg-green-50 text-green-600 border border-green-100", icon: <CheckCircle2 size={13} /> },
    rejected: { label: "Rejected", className: "bg-red-50 text-red-500 border border-red-100", icon: <XCircle size={13} /> },
}

export const projectColumns: ColumnDef<ProjectApplication>[] = [
    {
        accessorKey: "title",
        header: ({ column }) => (
            <button
