          ...
          <div className="flex items-center gap-3 shrink-0">
            <SignedOut>
              <div className="flex items-center gap-2">
                <SignInButton>
                  <button className="text-xs font-medium text-slate-600 hover:text-[#0f172a] px-3 py-1.5 rounded-lg hover:bg-slate-50 transition-colors cursor-pointer">
                    Login
                  </button>
                </SignInButton>
                <SignUpButton>
                  <button className="text-xs font-medium text-white bg-[#0f172a] hover:bg-[#1e293b] px-4 py-1.5 rounded-lg transition-colors cursor-pointer shadow-sm">
                    Register
                  </button>
                </SignUpButton>
              </div>
              ...
              <UserButton
                ...
                appearance={{
                  elements: {
                    ...
                    userButtonOuterIdentifier: "text-xs font-medium text-[#0f172a]",
                  },
                }}
              >
