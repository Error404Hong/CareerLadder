...
export function DiscussionTab({ projectId, projectTitle, userId, userName, userImage, ownerCompanyId, memberIds }: DiscussionTabProps) {
    ...
    useEffect(() => {
        ...
        const init = async () => {
            try {
                ...
                // All unique participants: owner + all members
                const allMemberIds = [...new Set([ownerCompanyId, ...memberIds, userId])]
