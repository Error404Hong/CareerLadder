...
import { Star, MessageSquareText, ClipboardList, UserRound } from "lucide-react"
...
const SKILL_FIELDS: { key: keyof Omit<EvaluationFormValues, "student_id" | "comments" | "overall_rating">; label: string }[] = [
...
function EvaluateStudentsForm({ projectApplicants, employer }: { projectApplicants: ProjectApplicant[]; employer: string }) {
...
export function ReviewsAndEvaluationTab({ reviews, projectApplicants, employer }: Props) {
    return (
                ...
                <div className="flex-1 p-5 overflow-auto">
                    ...
                    <TabsContent value="evaluate_students" className="mt-0">
                        {projectApplicants.length === 0 ? (
                            ...
                            <EvaluateStudentsForm projectApplicants={projectApplicants} employer={employer} />
                        )}
                    </TabsContent>
