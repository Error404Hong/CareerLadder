...
export function PaymentHistoryDataTable<TData, TValue>({
    columns,
    data,
    ...
    const [sorting, setSorting] = useState<SortingState>([{ id: "paid_at", desc: true }])
    ...
    const filteredData = statusFilter === "all"
        ? data
        : (data as Record<string, unknown>[]).filter(row => row["status"] === statusFilter) as TData[]
            ...
            <div className="flex items-center justify-between gap-3 flex-wrap">
                <div className="flex items-center gap-2">
                    ...
                    <Select value={statusFilter} onValueChange={setStatusFilter}>
                        <SelectTrigger className="w-36 text-sm text-slate-600">
