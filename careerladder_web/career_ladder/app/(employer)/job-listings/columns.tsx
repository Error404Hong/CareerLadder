...
export const getColumns = (
    ...
    onView: (id: string) => void
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <span className="text-sm text-slate-500">
                    RM {Number(row.original.salary_min).toLocaleString()} — RM {Number(row.original.salary_max).toLocaleString()}
                </span>
            )
        },
        {
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <span className="text-sm text-slate-500">{row.getValue("vacancies")}</span>
            )
        },
        {
            ...
            cell: ({ row }) => (
                <span className="text-sm text-slate-500">{Number(row.getValue("application_count"))}</span>
            )
        },
        {
            accessorKey: "status",
